...
use knowlattice_storage::repo::node::{NodeBaseRepository, NodeBase, NodeHeading, NodeHeadingRepository};
...
async fn node_heading_save_get_roundtrip() {
    ...
    let heading_repo: Arc<dyn NodeHeadingRepository> = repos.expect_repo();
