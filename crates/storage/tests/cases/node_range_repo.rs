...
use knowlattice_storage::repo::node::{NodeBaseRepository, NodeBase, NodeRangeRepository, NodeRange};
...
async fn node_range_save_get_roundtrip() {
    ...
    let range_repo: Arc<dyn NodeRangeRepository> = repos.expect_repo();
