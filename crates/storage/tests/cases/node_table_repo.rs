...
use knowlattice_storage::repo::node::{NodeBaseRepository, NodeBase, NodeTable, NodeTableRepository};
...
async fn node_table_save_get_roundtrip() {
    ...
    let table_repo: Arc<dyn NodeTableRepository> = repos.expect_repo();
